...
import com.example.Task.Management.Service.SprintService;
...
public class SprintController {
	...
	public ResponseEntity<Issue>assignToSprint(@PathVariable Long sprintId,@PathVariable Long issueId){
